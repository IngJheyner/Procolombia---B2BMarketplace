const EmojiPicker2 = function(options) {
    ...
    const functions = {
        ...
        render: (e, attr) => {
            ...
            this.insertInto = this.options.trigger[0].insertInto;
            ...
            const picker = `
                <div class="fg-emoji-container" style="left: ${position.left-200}px; top: ${position.top-420}px;">

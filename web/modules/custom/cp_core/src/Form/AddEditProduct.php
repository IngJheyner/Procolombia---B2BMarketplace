...
class AddEditProduct extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $nid = NULL) {
    ...
    if (empty($company_nid)) {
      ...
      // Hidden fields
      $form['type_form'] = array('#type' => 'hidden', '#value' => $type);
      $form['nid'] = array('#type' => 'hidden', '#value' => $nid);
      $form['company_nid'] = array('#type' => 'hidden', '#value' => $company_nid);
      ...
      // Product info
      $form['prod_info_sp_en'] = array(
        '#type' =>'container',
        '#attributes' => array(
          'class' => array('ctn-product-info row'),
        ),
      );
      ...
      $form['prod_info_sp_en']['left'] = array(
        '#type' => 'container',
        '#attributes' => array(
      ...
      $title_es_fields .= '</h3>';
      $form['prod_info_sp_en']['left']['title'] = array(
      ...
      $form['prod_info_sp_en']['left']['product_name_es'] = array(
        '#type' => 'textfield',
        '#size' => 60,
      ...
      $form['prod_info_sp_en']['left']['descp_es'] = array(
      ...
      $form['prod_info_sp_en']['left']['technique_file_es'] = array(
        '#type' => 'managed_file',
        ...
        '#upload_validators' => array(
          ...
          'file_validate_size' => array((1*1024*1024)/2),
        ),
      ...
      $form['prod_info_sp_en']['left']['certificate_es'] = array(
        '#type' => 'managed_file',
        '#name' => 'certificate_es',
      ...
      $form['prod_info_sp_en']['right'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('col-md-6'),
        ),
      ...
      $title_en_fields .= '</h3>';
      $form['prod_info_sp_en']['right']['title'] = array(
      ...
      $form['prod_info_sp_en']['right']['product_name_en'] = array(
        '#type' => 'textfield',
        '#size' => 60,
      ...
      $form['prod_info_sp_en']['right']['descp_en'] = array(
      ...
      $form['prod_info_sp_en']['right']['technique_file_en'] = array(
        '#type' => 'managed_file',
      ...
      $form['prod_info_sp_en']['right']['certificate_en'] = array(
        '#type' => 'managed_file',
        '#name' => 'certificate_en',
      ...
      // Product info
      $form['prod_info_all_lang'] = array(
        '#type' =>'container',
        '#attributes' => array(
          'class' => array('ctn-product-info-all-lang row'),
        ),
      );
      ...
      $form['prod_info_all_lang']['title_all_lang_fields'] = array(
        '#markup' => $title_all_lang_fields,
      );

      $form['prod_info_all_lang']['left'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('col-md-6 ctn-hs'),
        ),
      );
      ...
      $form['prod_info_all_lang']['left']['prod_type'] = array(
        '#type' => 'select',
      ...
      $form['prod_info_all_lang']['left']['partida_arancelaria_tax'] = array(
        ...
        '#selection_settings' => [
          ...
          'target_bundles' => array('partida_arancelaria'),
        ],
        '#states' => array(
          'visible' => array(
            ':input[name="prod_type"]' => array('value' => 'product'),
      ...
      $form['prod_info_all_lang']['left']['sector'] = array(
        '#type' => 'select',
        '#required' => TRUE,
        '#title' => 'Categoría',
      ...
      $form['prod_info_all_lang']['left']['subsector'] = array(
      ...
      $form['prod_info_all_lang']['right'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('col-md-6'),
        ),
      ...
      $form['prod_info_all_lang']['right']['export_markets'] = array(
        '#type' => 'entity_autocomplete',
        '#maxlength' => 200,
        ...
        '#selection_settings' => [
          ...
          'target_bundles' => array('countries'),
        ]
      );
      ...
      $form['product_images'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('ctn-product-images row'),
        ),
      );

      $form['product_images']['title'] = array(
      ...
      $form['product_images']['left'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('col-md-6'),
        ),
      ...
      $form['product_images']['right'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('col-md-6'),
        ),
      ...
      $form['product_images']['left']['img_1'] = array(
      ...
      $form['product_images']['left']['img_2'] = array(
        '#type' => 'managed_file',
        '#name' => 'img_2',
        '#title' => 'Imagen 2',
        '#size' => 20,
      ...
      $form['product_images']['left']['img_3'] = array(
        '#type' => 'managed_file',
        '#name' => 'img_3',
        '#title' => 'Imagen 3',
        '#size' => 20,
      ...
      $form['product_images']['right']['img_4'] = array(
        '#type' => 'managed_file',
        '#name' => 'img_4',
        '#title' => 'Imagen 4',
        '#size' => 20,
      ...
      $form['product_images']['right']['img_5'] = array(
        '#type' => 'managed_file',
        '#name' => 'img_5',
        '#title' => 'Imagen 5',
        '#size' => 20,
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
   ...
   /* $tariff_position = $form_state->getValue('tariff_position');*/
    ...
    if (!empty($technique_file_en)) {
      $technique_file_load_en = \Drupal\file\Entity\File::load($technique_file_en[0]);
    ...
    if (!empty($technique_file_es)) {
      $technique_file_load_es = \Drupal\file\Entity\File::load($technique_file_es[0]);
    ...
    if (!empty($certificate_file_en)) {
      foreach ($certificate_file_en as  $fid) {
        $certificate_file_load_en = \Drupal\file\Entity\File::load($fid);
    ...
    if (!empty($certificate_file_es)) {
      foreach ($certificate_file_es as  $fid) {
        $certificate_file_load_es = \Drupal\file\Entity\File::load($fid);
  ...
  /*      $old_tariff = $node->get('field_tariff_heading')->getString();
       ...
       /* $node->set('field_product_type', $prod_type);*/
        ...
        if (!empty($node) && !empty($node)) {
          ...
          $form_state->setRedirect('cp_core.editProduct', array('nid' => $node->id()));

        ...
        */
                ...
                */
                {
                    ...
                    "render": function (data, type, row, meta) {
                        if (row.status == 'Activo') {
                            return '<span><i class="bx bxs-circle circle approved"></i> ' + row.status + '</span>';
                        } else {
                            return '<span><i class="bx bxs-circle circle unanswered"></i> ' + row.status + '</span>';
                        }
                    }
                },
                {
        ...
        tableExportadores = $('#exportadores-list').DataTable({
            ...
            "columns": [
                ...
                {
                    "data": "id",
                    "render": function (td, data, type, row, meta) {
                        return '<a href="/adviser/buyer/' + row.id + '" class=""><img src="http://52.201.168.42/sites/default/files/matchmaking/images/internal/Editar.svg"></a>';
                    },
                    "title": "Action",
                    "className": "text-center"
